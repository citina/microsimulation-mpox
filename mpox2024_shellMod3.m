...
%     end
   ...
   % converting X people from sus to symptomatic every week starting from March 12 2023
    infect_id = find(alive==1 & pox_status==0);
    infect_id = randsample(infect_id, X);
